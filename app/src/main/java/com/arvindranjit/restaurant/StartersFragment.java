 ...
 * {@link StartersFragment.OnFragmentInteractionListener} interface
...
public class StartersFragment extends Fragment {
    ...
    private String[] names = {"Paneer Tikka","Chicken '65", "Honey Chicken","Chilly Prawns","French Fries" };

    private int[] prices = {219,259,319,459,79};
    private int[] quantity = {1,1,1,1,1};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RecyclerAdapterS(images,names,prices,'s',quantity);
